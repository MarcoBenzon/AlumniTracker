            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId())
                {
                    ...
                    case R.id.nav_aboutus:
                        ...
                        Intent intentaboutus = new Intent(Admin.this, Aboutus.class);
                        startActivity(intentaboutus);
                        break;

                    case R.id.nav_graduates:

                        Intent intentgraduates = new Intent(Admin.this, AdminListGraduates.class);
                        startActivity(intentgraduates);
                        break;

                    case R.id.nav_logout:
                        Intent intentlogout = new Intent(Admin.this, Login.class);
                        FirebaseAuth.getInstance().signOut();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.dashboardAnnouncement:
                i = new Intent(this, AdminAnnouncement.class);
                startActivity(i);
                break;

            case R.id.dashboardEvents:
                i = new Intent(this, AdminEvents.class);
                startActivity(i);
                break;

            case R.id.dashboardJobs:
                i = new Intent(this, AdminJobs.class);
                startActivity(i);
                break;
        }
    }
